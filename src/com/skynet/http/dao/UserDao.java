...
public class UserDao implements Dao<Integer, User> {
    ...
    private static final String GET_BY_EMAIL_AND_PASSWORD_SQL = "SELECT * FROM users WHERE email = ?" +
                                                                "AND password = ?";
